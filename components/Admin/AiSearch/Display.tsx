...
const Display = ({ aiSearch, handleEdit, handleDelete }) => {
  ...
  return (
    <div className='prompt_card'>
      ...
      <p className='my-4 font-satoshi text-sm text-gray-700'>{aiSearch.Header}</p>
      <p className='my-4 font-satoshi text-sm text-gray-700'>{aiSearch.service}</p>
      <p className='my-4 font-satoshi text-sm text-gray-700'>{aiSearch.description}</p>
