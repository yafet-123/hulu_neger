  ...
  return (
    <section className="w-full lg:px-20">
      ...
      <p className="desc text-left max-w-md">
        {type} the {typeofCategory} that are used to search the ai that are used
        in different fields
      </p>
        ...
        <div className="flex flex-col my-10 w-full px-2">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 my-5 px-2">
            <div className="relative flex-1">
              <input
                ...
                onChange={(e) =>
                  setaiSearch({ ...aiSearch, Header: e.target.value })
                }
              />
              <label
            ...
            <div className="relative flex-1">
              <input
                ...
                value={aiSearch.link}
                onChange={(e) =>
                  setaiSearch({ ...aiSearch, link: e.target.value })
                }
              />
              <label
                htmlFor="floating_outlined"
          ...
          <div className="relative flex-1">
            <textarea
              ...
              onChange={(e) =>
                setaiSearch({ ...aiSearch, description: e.target.value })
              }
            />
            <label
              htmlFor="floating_outlined"
